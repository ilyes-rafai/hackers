...
const Card = React.memo(({ src, transform, cardW, cardH }) => (
        ...
        >
                <div
                        className="w-full h-full rounded-2xl overflow-hidden bg-white dark:bg-neutral-800
                 border border-neutral-200 dark:border-neutral-700 shadow-lg dark:shadow-neutral-900/50
                 transition-transform duration-300 hover:scale-105 hover:shadow-2xl dark:hover:shadow-neutral-900/70
                 hover:z-10"
                        style={{
