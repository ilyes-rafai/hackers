...
// Poppins is not guaranteed to be available on the host page, so the component
// loads it on demand whenever the default font is used.
const DEFAULT_FONT_URL = "https://fonts.googleapis.com/css2?family=Poppins:wght@400&display=swap";
...
async function resolveFont(font, fontUrl) {
        // Use the bundled Poppins stylesheet when the caller relies on the default
...
class App {
        ...
        createMedias(items, bend = 1, textColor, borderRadius, font) {
                const defaultItems = [
                        { image: "/img/roads/modern-web-frontend.png", text: "Modern Web Frontend" },
                        { image: "/img/roads/office-suite-mastery.png", text: "Office Suite Mastery" },
                        { image: "/img/roads/python-mastery.png", text: "Python Mastery" },
                        { image: "/img/roads/team-coding.png", text: "Team Coding" },
                        { image: "/img/roads/ui-ux-design.png", text: "UI/UX Design" },
                        { image: "/img/roads/web-backend-code.png", text: "Web Backend Code" },
                        { image: "/img/roads/web-frontend-core.png", text: "Web Frontend Core" },
                        { image: "/img/roads/web-hacking.png", text: "Web Hacking" },
                ];
